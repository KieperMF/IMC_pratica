        ...
        children: [
          ...
          TextField(
           ...
           keyboardType: TextInputType.number,
            onChanged: (text) {
              if (text.length == 3) {
                _controller2.text = '${text.substring(0, 1)}.${text.substring(1)}';
          ...
          if (imc != null) Text('IMC: $imc', style: const TextStyle(fontSize: 20)),
          if (imc == null) const Text('IMC:', style: TextStyle(fontSize: 20)),
          if (classif != null) Text('Classificação: $classif', style: const TextStyle(fontSize: 20)),
          if (classif == null) const Text('Classificação:', style: TextStyle(fontSize: 20)),
        ],
      ),
    );
  }
